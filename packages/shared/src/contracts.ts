...
export const CONTRACT_ADDRESSES = {
  ...
  AGENT_REGISTRY: process.env.NEXT_PUBLIC_REGISTRY_ADDRESS || '0x0000000000000000000000000000000000000000',
  TASK_ESCROW: process.env.NEXT_PUBLIC_ESCROW_ADDRESS || '0x0000000000000000000000000000000000000000',
  SLASHING_JUDGE: process.env.NEXT_PUBLIC_JUDGE_ADDRESS || '0x0000000000000000000000000000000000000000',
  CRUCIBLE_INFT: process.env.NEXT_PUBLIC_INFT_ADDRESS || '0x0000000000000000000000000000000000000000',
};
